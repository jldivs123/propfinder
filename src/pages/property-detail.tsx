...
import { useScreenSize, TrimString } from "../utils";
...
const renderRooms = () => {
  return DUMMY_IMAGES.map((imageObj) => {
    return (
      <Box
...
const getQuiltedImageSize = (index: number) => {
  switch (index) {
    case 0:
